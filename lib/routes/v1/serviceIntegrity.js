...
module.exports = function(app) {
    ...
    .main(function (req, res) {
        ...
        return resourceManager.inspectIntegrity(
            //when spread==false, exclude 'serviser' group of remote resources
            //aka. exclude resources which are tagged with 'serviser' label
            req.query.spread ? undefined : 'serviser',
